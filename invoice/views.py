...
class InvoiceItemCreateView(OwnItemMixin, SuccessMessageMixin, CreateView):
    ...
    def handle_no_permission(
        self, login_args=None, permission_redirect="invoice-list", login_redirect="invoice-item-add"
    ):
        if login_args is None:
            login_args = [self.kwargs["invoice_id"]]
        return super().handle_no_permission(
            login_redirect=login_redirect, login_args=login_args, permission_redirect=permission_redirect
        )
...
class InvoiceItemUpdateView(OwnItemMixin, SuccessMessageMixin, UpdateView):
    ...
    def handle_no_permission(
        self, login_args=None, permission_redirect="invoice-list", login_redirect="invoice-item-update"
    ):
        if login_args is None:
...
class InvoiceItemDeleteView(OwnItemMixin, SuccessMessageMixin, DeleteView):
    ...
    def handle_no_permission(
        self, login_args=None, permission_redirect="invoice-list", login_redirect="invoice-item-delete"
    ):
        if login_args is None:
            login_args = [self.kwargs["invoice_id"], self.kwargs["invoice_item_id"]]
        return super().handle_no_permission(
