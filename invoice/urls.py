...
urlpatterns = [
    ...
    path('invoice/<int:invoice_id>/item/<int:invoice_item_id>/', views.InvoiceItemUpdateView.as_view(),
         name='invoice-item-update'),
    path('invoice/<int:invoice_id>/item/<int:invoice_item_id>/delete/', views.InvoiceItemDeleteView.as_view(),
