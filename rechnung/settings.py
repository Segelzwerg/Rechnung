...
env = FileAwareEnv(expand_vars=True, strip_whitespace=True)
...
SECRET_KEY = env.str("SECRET_KEY", default="django-insecure-!my8@3anjo9%iex=wfzsgi9&xg^u7*d6jn&_d13v-crv3xovv_")
